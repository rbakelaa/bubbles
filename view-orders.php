...
<?php
				...
				while($row = mysql_fetch_array($result)) 
				{
					...
					echo '<td><a href="http://localhost/bubbles/edit-orders.php?id=' . $row['id'] . '">Edit</a></td>';
					echo '<td><a href="http://localhost/bubbles/remove-orders.php?id=' . $row['id'] . '" onclick="return confirm(' . "'Are you sure you want to delete this order?'".')">Delete</a></td>';
					echo "</tr>";	
					echo "<tr></tr>";		
				} 
